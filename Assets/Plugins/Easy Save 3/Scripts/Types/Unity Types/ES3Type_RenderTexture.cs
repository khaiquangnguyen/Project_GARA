...
namespace ES3Types
{
    ...
    public class ES3Type_RenderTexture : ES3ObjectType
    {
        ...
        protected override void WriteObject(object obj, ES3Writer writer)
        {
            ...
            writer.WriteProperty("streamingTextureDiscardUnusedMips",
                UnityEngine.RenderTexture.streamingTextureDiscardUnusedMips, ES3Type_bool.Instance);
            writer.WriteProperty("allowThreadedTextureCreation", UnityEngine.RenderTexture.allowThreadedTextureCreation,
                ES3Type_bool.Instance);
#endif
        }
                ...
                switch (propertyName)
                {
                    ...
                    case "anisotropicFiltering":
                        UnityEngine.RenderTexture.anisotropicFiltering =
                            reader.Read<UnityEngine.AnisotropicFiltering>();
                        break;
                    case "wrapMode":
