...
namespace Unity.Pipeline.Tests.Runtime
{
    ...
    class PipelineClient : IDisposable
    {
        ...
        public IEnumerator ExecuteCommandAsync(string command, object parameters,
            System.Action<PipelineResponse> onComplete)
        ...
        public async Task<PipelineResponse> GetAsync(string endpoint)
        {
            ...
            {
                return new PipelineResponse { IsSuccess = false, Error = ex.Message, RawResponse = "" };
            }
        }
        ...
        {
            var payload = new { command = command, parameters = parameters ?? new { } };
        ...
        {
            var parameters = new { code = code, timeout = timeout };
    ...
    class PipelineResponse
    {
        ...
        public override string ToString()
        {
            ...
            return
                $"{status} ({StatusCode}) - {content}: {RawResponse?.Substring(0, Math.Min(100, RawResponse.Length))}...";
        }
    }
    ...
    static class PipelineClientExtensions
    {
        ...
        /// </summary>
        public static IEnumerator ExecuteCodeWithResponseAsync(this PipelineClient client, string code, int timeout,
            System.Action<Unity.Pipeline.Models.EvalResponse> onComplete)
        {
        ...
        /// </summary>
        public static async Task<Unity.Pipeline.Models.EvalResponse> ExecuteCodeWithResponseAsync(
            this PipelineClient client, string code, int timeout = 5000)
        {
