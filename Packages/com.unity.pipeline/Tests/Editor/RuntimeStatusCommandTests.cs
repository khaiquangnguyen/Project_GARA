    ...
    class RuntimeStatusCommandTests
    {
        ...
        public void GetRuntimeStatus_NoDriverBootstrapped_PipelineDriverIsNull()
        {
            ...
            try
            {
                ...
                Assert.IsNull(response.PipelineDriver,
                    "No driver was ever bootstrapped in this test, so there is nothing to report");
            }
            finally
            {
        ...
        public void GetRuntimeStatus_DriverBootstrapped_ReportsDriverStatus()
        {
            ...
            try
            {
                ...
                Assert.IsFalse(response.PipelineDriver.IsServerRunning,
                    "autoStart is false, so the server itself never started");
            }
            finally
            {
