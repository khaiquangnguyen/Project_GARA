    ...
    class PackageManagerCommandTests
    {
        ...
        public void AllPackageCommands_AreDiscovered()
        {
            ...
            foreach (var command in new[]
                     {
                         "package_list", "package_search", "package_add", "package_remove", "package_resolve",
                         "package_status"
                     })
            {
        ...
        public void PackageList_InstalledScope_ReturnsResultsSynchronously()
        {
            ...
            Assert.IsTrue(response.Packages.TrueForAll(p => p.IsInstalled),
                "installed scope: every entry is installed");
        }
        ...
        public void PackageList_DirectDependenciesOnly_AreFewerThanAll()
        {
            ...
            Assert.IsTrue(direct.Packages.TrueForAll(p => p.IsDirectDependency),
                "include_indirect=false should drop transitive deps");
        }
        ...
        public void PackageStatus_IsOffMainThread()
        {
            ...
            Assert.IsFalse(command.MainThreadRequired,
                "package_status only reads a file; it must respond while an op is in flight");
        }
        ...
        public void PackageAdd_ExposesGateArgs()
        {
            ...
            Assert.AreEqual("boolean", properties["wait"]?["type"]?.ToString(),
                "add should expose the dual-mode wait flag");
        ...
        public void PackageAdd_WithoutConfirm_IsRejected()
        {
            ...
            var response =
                (PackageMutationResponse)PackageManagerCommand.PackageAdd("com.unity.foo@1.2.3", confirm: false);
        ...
        {
            var response =
                (PackageMutationResponse)PackageManagerCommand.PackageRemove("com.unity.foo", confirm: false);
