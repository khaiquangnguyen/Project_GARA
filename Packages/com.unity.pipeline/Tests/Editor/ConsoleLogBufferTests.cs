    ...
    class ConsoleLogBufferTests
    {
        ...
        public void Load_ClampsRestoredEntriesToCapacityKeepingMostRecent()
        {
            ...
            try
            {
                ...
                File.WriteAllText(path,
                    JsonConvert.SerializeObject(new { lastSeq = (long)(ConsoleLogBuffer.Capacity + 5), entries }));
        ...
        public void Load_NeverLowersLastSeq()
        {
            ...
            try
            {
                ...
                File.WriteAllText(path,
                    JsonConvert.SerializeObject(new { lastSeq = 5L, entries = Array.Empty<ConsoleLogEntry>() }));
