...
namespace Unity.Pipeline.Tests.Editor.Animation
{
    ...
    class AnimatorControllerCommandsTests
    {
        ...
        public void AddParameter_Float_AndDuplicate()
        {
            ...
            var added = AnimatorControllerCommands.AddAnimatorParameter(PathRef(path), "Speed", "Float",
                new JValue(0f));
        ...
        public void AddLayer_AppendsLayer()
        {
            ...
            var added = AnimatorControllerCommands.AddAnimatorLayer(PathRef(path), "Upper", weight: 0.5f,
        ...
        public void AddTransition_ModeTypeMismatch_Throws()
        {
            ...
            var conditions = new JArray { new JObject { ["parameter"] = "Speed", ["mode"] = "If" } };
        ...
        public void AddTransition_ExitTimeOutOfRange_Throws()
        {
            ...
            Assert.Throws<System.ArgumentException>(() => AnimatorControllerCommands.AddAnimatorTransition(
