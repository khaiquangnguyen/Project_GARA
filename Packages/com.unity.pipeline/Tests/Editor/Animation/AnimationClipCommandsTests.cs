    ...
    class AnimationClipCommandsTests
    {
        ...
        public void CreateAnimationClip_OutOfProject_Throws()
        {
            ...
            Assert.Throws<System.ArgumentException>(() =>
                AnimationClipCommands.CreateAnimationClip("Assets/../Outside.anim"));
        }
        ...
        public void SetAnimationCurve_ReplaceExisting_Overwrites()
        {
            ...
            var result =
                AnimationClipCommands.SetAnimationCurve(PathRef(path), "", "Transform", "m_LocalPosition.x", threeKeys);
        ...
        public void SetAnimationCurve_UnknownType_Throws()
        {
            ...
            Assert.Throws<System.ArgumentException>(() =>
                AnimationClipCommands.SetAnimationCurve(PathRef(path), "", "NotARealComponent__CLI214", "m_X",
                    TwoKeys()));
        }
        ...
        public void SetAnimationCurve_ViaClient_Succeeds()
        {
            ...
            {
                var response = server.Execute("set_animation_curve",
                    new
                    {
                        clip = new { path },
                        type = "Transform",
                        property = "m_LocalPosition.x",
                        keys = new object[] { new { time = 0f, value = 0f }, new { time = 1f, value = 5f } }
                    });
