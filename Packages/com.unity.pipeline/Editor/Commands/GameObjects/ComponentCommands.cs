...
namespace Unity.Pipeline.Editor.Commands.GameObjects
{
    ...
    static class ComponentCommands
    {
        ...
        public static AuthoringResult AddComponent(
            ...
            ObjectRef target,
            [CliArg("type", "Component type name (e.g. 'Rigidbody' or 'UnityEngine.Camera').", Required = true)]
            string type)
        {
        ...
        public static AuthoringResult RemoveComponent(
            [CliArg("target", "Handle of the component to remove, OR of the GameObject when 'type' is given.",
                Required = true)]
            ObjectRef target,
            [CliArg("type",
                "Component type name to remove from the target GameObject (omit when 'target' already points at a component).")]
            string type = null)
        {
        ...
        public static ComponentPropertiesResult GetComponentProperties(
            [CliArg("target", "Handle of the component, OR of the GameObject when 'type' is given.", Required = true)]
            ObjectRef target,
            [CliArg("type", "Component type name on the target GameObject (omit when 'target' is a component handle).")]
            string type = null)
        {
            var component = ResolveComponent(target, type);
            ...
            {
                Component = ObjectResolver.Describe(component), Properties = properties
            };
        }
        ...
        public static ComponentPropertiesResult SetComponentProperties(
            ...
            ObjectRef target,
            [CliArg("properties",
                "Map of serialized property name to value. Vectors/colors are arrays; object refs are handle objects.",
                Required = true)]
            JObject properties,
            [CliArg("type", "Component type name on the target GameObject (omit when 'target' is a component handle).")]
            string type = null)
        ...
        private static Component ResolveComponent(ObjectRef handle, string type)
        {
            ...
            if (go == null)
                throw new ArgumentException(
                    $"'target' did not resolve to a GameObject or Component (got {obj.GetType().Name}).");
