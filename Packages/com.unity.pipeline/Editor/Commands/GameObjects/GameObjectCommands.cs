...
namespace Unity.Pipeline.Editor.Commands.GameObjects
{
    ...
    static class GameObjectCommands
    {
        ...
        public static AuthoringResult CreateGameObject(
            ...
            string name = null,
            [CliArg("primitive",
                "Optional primitive type: cube, sphere, capsule, cylinder, plane, quad. Omit for an empty GameObject.")]
            string primitive = null,
            [CliArg("parent",
                "Optional parent handle (globalId/path/guid/instanceId/hierarchyPath). The new object becomes a child of it.")]
        ...
        public static CreateGameObjectsResult CreateGameObjects(
            [CliArg("name", "Base name. With count>1 and no explicit names, objects are suffixed Name1..NameN.")]
            string name = null,
            [CliArg("primitive",
                "Optional primitive type: cube, sphere, capsule, cylinder, plane, quad. Omit for empty GameObjects.")]
            string primitive = null,
            [CliArg("parent", "Optional parent handle. Every created object becomes a child of it.")]
            ObjectRef parent = null,
            [CliArg("count", "How many GameObjects to create. Default 1.")]
            int count = 1,
            [CliArg("positions", "Local positions, one [x,y,z] per object. Length must equal count when supplied.")]
            float[][] positions = null,
            [CliArg("rotations",
                "Local Euler rotations (degrees), one [x,y,z] per object. Length must equal count when supplied.")]
            float[][] rotations = null,
            [CliArg("scales", "Local scales, one [x,y,z] per object. Length must equal count when supplied.")]
            float[][] scales = null)
        {
            if (count < 1)
        ...
        public static FindGameObjectsResult FindGameObjects(
            [CliArg("name", "Exact name to match.")]
            string name = null,
            [CliArg("tag", "Tag to match (e.g. 'Player').")]
            string tag = null,
            [CliArg("type", "Component type name to match (e.g. 'Rigidbody', 'UnityEngine.Camera').")]
            string type = null,
            [CliArg("hierarchy_path", "Exact hierarchy path to match (e.g. '/Root/Child').")]
            string hierarchyPath = null,
            [CliArg("include_inactive", "Include inactive GameObjects. Default true.")]
        ...
        public static AuthoringResult SetTransform(
            [CliArg("target", "Handle of the GameObject to modify.", Required = true)]
            ObjectRef target,
            [CliArg("position", "Local position as [x,y,z].")]
            float[] position = null,
            [CliArg("rotation", "Local rotation as Euler angles [x,y,z] in degrees.")]
            float[] rotation = null,
            [CliArg("scale", "Local scale as [x,y,z].")]
            float[] scale = null)
        {
        ...
        public static AuthoringResult SetParent(
            [CliArg("target", "Handle of the GameObject to reparent.", Required = true)]
            ObjectRef target,
            [CliArg("parent", "Handle of the new parent. Omit (or empty) to move the object to the scene root.")]
            ObjectRef parent = null,
            [CliArg("world_position_stays", "Keep the object's world position when reparenting. Default true.")]
        ...
        public static AuthoringResult SetActive(
            [CliArg("target", "Handle of the GameObject.", Required = true)]
            ObjectRef target,
            [CliArg("active", "Desired active state.", Required = true)]
            bool active)
        {
            var go = ResolveGameObject(target, "target");
        ...
        public static AuthoringResult SetTag(
            [CliArg("target", "Handle of the GameObject.", Required = true)]
            ObjectRef target,
            [CliArg("tag", "Tag to assign (must exist in the Tag Manager).", Required = true)]
            string tag)
        {
            var go = ResolveGameObject(target, "target");
            if (!InternalEditorTagExists(tag))
                throw new ArgumentException(
                    $"Tag '{tag}' does not exist in the project. Add it via the Tag Manager first.");
        ...
        public static AuthoringResult SetLayer(
            [CliArg("target", "Handle of the GameObject.", Required = true)]
            ObjectRef target,
            [CliArg("layer", "Layer name (e.g. 'UI') or numeric index 0-31.", Required = true)]
            string layer)
        {
            var go = ResolveGameObject(target, "target");
        ...
        public static AuthoringResult RenameGameObject(
            [CliArg("target", "Handle of the GameObject.", Required = true)]
            ObjectRef target,
            [CliArg("name", "New name.", Required = true)]
            string name)
        {
        ...
        public static AuthoringResult DeleteGameObject(
            [CliArg("target", "Handle of the GameObject to delete.", Required = true)]
            ObjectRef target)
        {
            var go = ResolveGameObject(target, "target");
        ...
        private static Vector3 ToVector3(float[] values, string argName)
        {
            ...
            if (values.Length != 3)
                throw new ArgumentException(
                    $"'{argName}' must have exactly 3 components [x,y,z], got {values.Length}.");
